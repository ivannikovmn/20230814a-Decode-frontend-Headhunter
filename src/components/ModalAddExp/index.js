    ...
    return(
        <div className="modal">
            ...
            <div className="modal-inner">
                ...
                {/* {startDate} {testdate.toLocaleDateString()} */}
                ...
                <textarea className="textarea" placeholder="Опишите что вы делали на работе" type="text" onChange={onChangeRes}>{responsibilities}</textarea>
